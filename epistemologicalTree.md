...
| 690 | Library of Ashurbanipal, Mesopotamia [Library of Nineveh (668-627 BC) with Irving Finkel](https://www.youtube.com/live/Ls9JkxFEB9g) <br> - owned by the king for the king only inherited from his father<br> - Gilgamesh story (which includes the big flood and the arch)<br> - Ark Before Noah with Irving [Finkel](https://youtu.be/s_fkpZSnz2I?si=e-UB304xbIPUhBA1) <br> - cuneiform writing <br> - the Babylonian alphabet didn't survive, but the knowledge (which went from Babylon to the Greeks) |
